...
function Srnciatka() {
    ...
    const heroImgY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(scrollY, [
        0,
        800
    ], [
        0,
    ...
    const [mobileIdx, setMobileIdx] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const galleryInView = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$utils$2f$use$2d$in$2d$view$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInView"])(galleryRef, {
        once: true
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Srnciatka.useEffect": ()=>{
            const id = setInterval({
                "Srnciatka.useEffect.id": ()=>setMobileIdx({
                        "Srnciatka.useEffect.id": (i)=>(i + 1) % MOBILE_IMGS.length
                    }["Srnciatka.useEffect.id"])
            }["Srnciatka.useEffect.id"], 4000);
            return ({
                "Srnciatka.useEffect": ()=>clearInterval(id)
            })["Srnciatka.useEffect"];
        }
    }["Srnciatka.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Srnciatka.useEffect": ()=>{
            ...
            let busy = false;
            const getSections = {
                "Srnciatka.useEffect.getSections": ()=>Array.from(document.querySelectorAll(`[${ATTR}]`))
            }["Srnciatka.useEffect.getSections"];
            const syncCurrent = {
                "Srnciatka.useEffect.syncCurrent": ()=>{
                    if (busy) return;
                    const all = getSections();
                    const idx = all.findIndex({
                        "Srnciatka.useEffect.syncCurrent.idx": (el)=>{
                            const top = el.getBoundingClientRect().top;
                            return top >= -10 && top < window.innerHeight * 0.5;
                        }
                    }["Srnciatka.useEffect.syncCurrent.idx"]);
                    if (idx !== -1) current = idx;
                }
            }["Srnciatka.useEffect.syncCurrent"];
            const go = {
                "Srnciatka.useEffect.go": (idx)=>{
                    const all = getSections();
            ...
            }["Srnciatka.useEffect.go"];
            const onWheel = {
                "Srnciatka.useEffect.onWheel": (e)=>{
                    e.preventDefault();
                    if (busy) return;
                    syncCurrent();
                    go(current + (e.deltaY > 0 ? 1 : -1));
                }
            }["Srnciatka.useEffect.onWheel"];
            let ty = 0;
            const onTouchStart = {
                "Srnciatka.useEffect.onTouchStart": (e)=>{
                    ty = e.touches[0].clientY;
                }
            }["Srnciatka.useEffect.onTouchStart"];
            const onTouchMove = {
                "Srnciatka.useEffect.onTouchMove": (e)=>{
                    e.preventDefault();
                }
            }["Srnciatka.useEffect.onTouchMove"];
            const onTouchEnd = {
                "Srnciatka.useEffect.onTouchEnd": (e)=>{
                    if (busy) return;
                    syncCurrent();
                    const d = ty - e.changedTouches[0].clientY;
                    if (Math.abs(d) > 40) go(current + (d > 0 ? 1 : -1));
                }
            }["Srnciatka.useEffect.onTouchEnd"];
            const onKey = {
                "Srnciatka.useEffect.onKey": (e)=>{
                    if (busy) return;
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: MOBILE_IMGS.map((_, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: [
...
_s(Srnciatka, "UPw9c4zMvHfyhy3gNVmYYAtxaLU=", false, function() {
    return [
...
//# sourceMappingURL=src_components_5bf356b6._.js.map